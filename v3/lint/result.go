...
const (
	...
	Pass   LintStatus = 3
	Notice LintStatus = 4 // MAY, OPTIONAL
	Warn   LintStatus = 5 // SHOULD, RECOMMENDED, SHOULD NOT, NOT RECOMMENDED,
	Error  LintStatus = 6 // MUST NOT, SHALL NOT, MUST, REQUIRED, SHALL
	Fatal  LintStatus = 7 // 解析失败
)
