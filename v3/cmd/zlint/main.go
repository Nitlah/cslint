/*
 * CSLint Copyright 2021 Regents of the University of Michigan
 *
...
func init() {
	...
	flag.BoolVar(&printVersion, "version", false, "Print CSLint version and exit")
	...
	flag.Usage = func() {
		fmt.Fprintf(os.Stderr, "CSLint version %s\n\n", version)
