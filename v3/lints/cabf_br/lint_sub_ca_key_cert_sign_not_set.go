...
func NewSubCaKeyCertSignNotSet() lint.LintInterface {
	return &subCaKeyCertSignNotSet{}
}

func (l *subCaKeyCertSignNotSet) CheckApplies(c *x509.Certificate) bool {
	return util.IsSubCA(c) && util.IsExtInCert(c, util.KeyUsageOID)
}

func (l *subCaKeyCertSignNotSet) Execute(c *x509.Certificate) *lint.LintResult {
