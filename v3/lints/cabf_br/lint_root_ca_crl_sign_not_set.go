...
type rootCaCRLSignNotSet struct{}
...
func init() {
	lint.RegisterLint(&lint.Lint{
		Name:        "e_root_ca_crl_sign_not_set",
		...
		Lint:          NewRootCaCRLSignNotSet,
	})
}

func NewRootCaCRLSignNotSet() lint.LintInterface {
	return &rootCaCRLSignNotSet{}
}
