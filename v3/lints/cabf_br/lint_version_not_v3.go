...
func init() {
	lint.RegisterLint(&lint.Lint{
		Name:          "e_cert_version_not_3",
		Description:   "Certificates MUST be of type X.509 v3.",
		Citation:      "CSBR V3.4 7.1.1",
		Source:        lint.CSBaselineRequirements,
		EffectiveDate: util.CSBRV34DATE,
		Lint:          NewCSBRVersonNot3,
	})
}

func NewCSBRVersonNot3() lint.LintInterface {
	return &CSBRVersonNot3{}
}

func (l *CSBRVersonNot3) CheckApplies(cert *x509.Certificate) bool {
	return true
}

func (l *CSBRVersonNot3) Execute(cert *x509.Certificate) *lint.LintResult {
