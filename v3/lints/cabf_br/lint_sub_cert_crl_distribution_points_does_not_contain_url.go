...
type subCertCRLDistNoURL struct{}
...
func init() {
	lint.RegisterLint(&lint.Lint{
		...
		Lint:          NewSubCertCRLDistNoURL,
	})
}

func NewSubCertCRLDistNoURL() lint.LintInterface {
	return &subCertCRLDistNoURL{}
}

func (l *subCertCRLDistNoURL) CheckApplies(c *x509.Certificate) bool {
	return util.IsSubscriberCert(c) && util.IsExtInCert(c, util.CrlDistOID)
}

func (l *subCertCRLDistNoURL) Execute(c *x509.Certificate) *lint.LintResult {
