...
var (
	...
	// DSA with SHA-256            2.16.840.1.101.3.4.3.2
	OidSignatureSHA256withDSA = asn1.ObjectIdentifier{2, 16, 840, 1, 101, 3, 4, 3, 2}
	// DSA with SHA-1         1.2.840.10040.4.3
	OidSignatureSHA1withDSA = asn1.ObjectIdentifier{1, 2, 840, 10040, 4, 3}
	sha256WithRSAEncryption = asn1.ObjectIdentifier{1, 2, 840, 10040, 4, 3}
)
