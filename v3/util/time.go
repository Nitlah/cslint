...
var (
	// CSBR timeline
	CSBREffectiveDate = time.Date(2019, time.August, 13, 0, 0, 0, 0, time.UTC)
	//CSBRV12DATE       = time.Date(2019, time.August, 13, 0, 0, 0, 0, time.UTC)
	//CSBRV20DATE       = time.Date(2020, time.September, 2, 0, 0, 0, 0, time.UTC)
	//CSBRV21DATE       = time.Date(2020, time.November, 7, 0, 0, 0, 0, time.UTC)
	//CSBRV22DATE       = time.Date(2021, time.March, 8, 0, 0, 0, 0, time.UTC)
	//CSBRV23DATE       = time.Date(2021, time.May, 2, 0, 0, 0, 0, time.UTC)
	//CSBRV24DATE       = time.Date(2021, time.September, 8, 0, 0, 0, 0, time.UTC)
	//CSBRV25DATE       = time.Date(2021, time.September, 12, 0, 0, 0, 0, time.UTC)
	//CSBRV26DATE       = time.Date(2021, time.November, 3, 0, 0, 0, 0, time.UTC)
	//CSBRV27DATE       = time.Date(2021, time.December, 3, 0, 0, 0, 0, time.UTC)
	//CSBRV28DATE       = time.Date(2022, time.May, 6, 0, 0, 0, 0, time.UTC)
	CSBRV30DATE = time.Date(2022, time.June, 29, 0, 0, 0, 0, time.UTC)
...
// TODO(@cpu):
// This function is a little bit rough around the edges (especially
