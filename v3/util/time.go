...
var (
	...
	CABF_CSBR_2_6_Date = time.Date(2021, time.June, 1, 0, 0, 0, 0, time.UTC)
	// https://cabforum.org/wp-content/uploads/Baseline-Requirements-for-the-Issuance-and-Management-of-Code-Signing.v2.6.pdf p38
	CABF_CSBR_ALGO_ID_DATE = time.Date(2022, time.April, 30, 0, 0, 0, 0, time.UTC)
	MINI_RSA_MODULUS_SIZE  = time.Date(2021, time.June, 1, 0, 0, 0, 0, time.UTC)
)
